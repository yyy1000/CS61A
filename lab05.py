...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    coordinate = make_city("NoneCity",lat,lon)
    distance_a = distance(city_a,coordinate)
    distance_b = distance(city_b,coordinate)
...
def sprout_leaves(t, leaves):
    ...
    "*** YOUR CODE HERE ***"
    if is_leaf(t):
        branch_leaves = [tree(l) for l in leaves]
        return tree(label(t),branch_leaves)
    new_branches = [sprout_leaves(tr,leaves) for tr in branches(t)]
