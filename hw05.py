class VendingMachine:
    ...
    def vend(self):
        if self.count == 0:
            ...
            return f'You must add ${dif} more funds.'
        elif self.balance == self.price:
            self.count -= 1
            self.balance = 0 
            ...
            self.balance = 0
            return f'Here is your {self.name} and ${dif} change.'
...
def store_digits(n):
    ...
    while n > 10:
        n //= 10
        tem *= 10
    return Link(n, store_digits(save - n*tem))
...
def bst_max(t):
    ...
    for br in t.branches:
        max_val = max(max_val,bst_max(br))
    return max_val
...
def bst_min(t):
    ...
    min_val = t.label
    for br in t.branches:
        min_val = min(min_val,bst_min(br))
    return min_val
